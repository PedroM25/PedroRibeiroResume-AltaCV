...
\geometry{left=1.25cm,right=1.25cm,top=1.2cm,bottom=1.2cm,columnsep=0.7cm}
...
\makeatletter
\newcommand\SemiLarge{\@setfontsize\normalsize{9}{9}}
\makeatother

\makeatletter
\newcommand\SemiNormalSize{\@setfontsize\small{7.5}{7.5}}
\makeatother
...
% Custom colors
\definecolor{DarkBlue}{HTML}{256490}
\definecolor{LightBlue}{HTML}{4694b2}
\definecolor{LeastGrey}{HTML}{adadad}
\definecolor{NormalGrey}{HTML}{7b7b7b}
\definecolor{MoreGrey}{HTML}{6f6f6f}
\definecolor{MostGrey}{HTML}{595959}
...
\colorlet{name}{DarkBlue}
\colorlet{tagline}{LightBlue}
\colorlet{heading}{DarkBlue} % major titles
\colorlet{headingrule}{LeastGrey}
\colorlet{subheading}{PastelRed} % not in use
\colorlet{accent}{LightBlue} % secondary titles
\colorlet{emphasis}{SlateGrey} % not in use
\colorlet{body}{MostGrey}

% Custom color alias
\colorlet{icons}{LeastGrey}
\colorlet{sectionHeading}{MostGrey}

% Change some fonts, if necessary
\renewcommand{\namefont}{\HUGE}
\renewcommand{\taglinefont}{\Large} % added by me
\renewcommand{\personalinfofont}{\SemiLarge}
